	soc_system u0 (
		...
		.nios2_resetreq_pio_external_connection_export   (<connected-to-nios2_resetreq_pio_external_connection_export>),   //   nios2_resetreq_pio_external_connection.export
		.nios2_resettaken_pio_external_connection_export (<connected-to-nios2_resettaken_pio_external_connection_export>), // nios2_resettaken_pio_external_connection.export
		.reset_reset_n                                   (<connected-to-reset_reset_n>),                                   //                                    reset.reset_n
		.shared_mem_bridge_m0_waitrequest                (<connected-to-shared_mem_bridge_m0_waitrequest>),                //                     shared_mem_bridge_m0.waitrequest
		.shared_mem_bridge_m0_readdata                   (<connected-to-shared_mem_bridge_m0_readdata>),                   //                                         .readdata
		.shared_mem_bridge_m0_readdatavalid              (<connected-to-shared_mem_bridge_m0_readdatavalid>),              //                                         .readdatavalid
		.shared_mem_bridge_m0_burstcount                 (<connected-to-shared_mem_bridge_m0_burstcount>),                 //                                         .burstcount
		.shared_mem_bridge_m0_writedata                  (<connected-to-shared_mem_bridge_m0_writedata>),                  //                                         .writedata
		.shared_mem_bridge_m0_address                    (<connected-to-shared_mem_bridge_m0_address>),                    //                                         .address
		.shared_mem_bridge_m0_write                      (<connected-to-shared_mem_bridge_m0_write>),                      //                                         .write
		.shared_mem_bridge_m0_read                       (<connected-to-shared_mem_bridge_m0_read>),                       //                                         .read
		.shared_mem_bridge_m0_byteenable                 (<connected-to-shared_mem_bridge_m0_byteenable>),                 //                                         .byteenable
		.shared_mem_bridge_m0_debugaccess                (<connected-to-shared_mem_bridge_m0_debugaccess>)                 //                                         .debugaccess
	);
